...
<div class="right-bar">
  <div data-simplebar class="h-100">
    <div class="rightbar-title d-flex align-items-center bg-dark p-3">
      ...
      <h5 class="me-2 m-0 text-white">Theme Customizer</h5>
    ...
    <div class="p-4">
      ...
      <h6 class="sidebar-setting mt-4 mb-3 pt-2">Sidebar Size</h6>
      ...
      <h6 class="sidebar-setting mt-4 mb-3 pt-2">Sidebar Color</h6>
